...
public class ClienteController {
    ...
    public List<PedidoDTO> getPedidosCliente(@PathVariable int id) {
        Cliente cli = clienteServico.getClienteById(id);
        return pedidoServico.toListDTO(cli.getPedidos());
    }

    @PostMapping("/{id}/pedidos")
    public ResponseEntity<Void> salvar(@PathVariable int id, @RequestBody Pedido pedido, HttpServletRequest request,
            UriComponentsBuilder builder) {
